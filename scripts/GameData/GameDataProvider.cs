     ...
     where T : RuntimeGameData
{
    ...
    public virtual T GetRandom()
    {
        ...
        return this.FilteredList[EssentialCore.Random.RandiRange(0, this.FilteredList.Count)];
    }
    ...
    public virtual void Reload()
    {
        ...
        if (!EssentialCore.GameData.GetAll(this.Values))
        {
            EssentialCore.Logger.Warn("Game Data had no Monster information!");
            return;
        }
    ...
    {
        EssentialCore.Logger.Info("Game Data Changed, Reloading Monster Provider");
        this.Reload();
    }
}