...
/// <summary>
/// Telegram providers respond to {@link MessageDispatcher#addListener} by providing optional <see cref="Telegram.ExtraInfo"/> 
/// to be sent in a Telegram of a given type to the newly registered <see cref="ITelegraph"/>.
/// </summary>
public interface ITelegramProvider
{
    /// <summary>
    /// Provides <see cref="Telegram.ExtraInfo"/> to dispatch immediately when a <see cref="ITelegraph"/> is registered for the given message type
    /// </summary>
