...
public class TicketProviderManaged<T, TD> : IEnumerable<TD>
    where T : struct
    where TD : ITicketData
{
    ...
    private readonly bool updateDataEntries;
    ...
    // Constructor
    // -------------------------------------------------------------------
    public TicketProviderManaged(bool updateDataEntries = false)
    {
