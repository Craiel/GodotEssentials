...
public class KDTreePriorityList<TElement, TPriority> : IEnumerable<TElement>
    where TPriority : IComparable<TPriority>
{
    ...
    /// Especially if you will be creating and destroying many <see cref="KDTreePriorityList{TElement,TPriority}"/> very rapidly.
    ...
    /// <param name="allocate">If true, initializes the internal lists for the <see cref="KDTreePriorityList{TElement,TPriority}"/> with an initial capacity of <paramref name="capacity"/>.</param>
    public KDTreePriorityList(int capacity, bool allocate = false)
    {
